...
class Action {
  ...
  toString() {
    ...
    if (this.type === SEED) {
      return `${SEED} ${this.sourceCellIdx} ${this.targetCellIdx} | ${SEED} ${this.sourceCellIdx} ${this.targetCellIdx}`
    }
    return `${this.type} ${this.targetCellIdx} | ${this.type} ${this.targetCellIdx}`
  }
}
class Game {
  constructor() {
